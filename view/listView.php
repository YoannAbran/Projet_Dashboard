...
<table class='table table-striped table-light'>
          <thead>
            <tr>
              ...
              <th class='text-center align-middle' scope='col'><a class="text-dark" href="<?php echo "index.php?action=listbook&page_no=". $page_no."&orderBy=nom&sort=".(($ascdesc=='ASC')? 'DESC' : 'ASC').""?>">Nom</a></th>
              <th class='text-center align-middle' scope='col'><a class="text-dark" href="<?php echo "index.php?action=listbook&page_no=". $page_no."&orderBy=reference&sort=".(($ascdesc=='ASC')? 'DESC' : 'ASC').""?>">Reference</a></th>
              <th class='text-center align-middle' scope='col'><a class="text-dark" href="<?php echo "index.php?action=listbook&page_no=". $page_no."&orderBy=date_achat&sort=".(($ascdesc=='ASC')? 'DESC' : 'ASC').""?>">Achat</a></th>
              <th class='text-center align-middle' scope='col'><a class="text-dark" href="<?php echo "index.php?action=listbook&page_no=". $page_no."&orderBy=date_garantie&sort=".(($ascdesc=='ASC')? 'DESC' : 'ASC').""?>">Garantie</a></th>
              <th class='text-center align-middle' scope='col'><a class="text-dark" href="<?php echo "index.php?action=listbook&page_no=". $page_no."&orderBy=prix&sort=".(($ascdesc=='ASC')? 'DESC' : 'ASC').""?>">Prix d'achat</a></th>
              ...
              <th class='text-center align-middle' scope='col'><a class="text-dark" href="<?php echo "index.php?action=listbook&page_no=". $page_no."&orderBy=categorie&sort=".(($ascdesc=='ASC')? 'DESC' : 'ASC').""?>">Catégorie</a></th>
...
?>
  ...
  <?php if($page_no > 1){
  echo "<li class='page-item'><a class='  text-dark page-link' href='index.php?action=listbook&page_no=1&orderBy=$order&sort=$ascdesc'>First Page</a></li>";
  } ?>
  ...
  echo "<li><a class=' text-dark page-link' href='index.php?action=listbook&page_no=$total_no_of_pages&orderBy=$order&sort=$ascdesc'>Last &rsaquo;&rsaquo;</a></li>";
  } ?>
  </ul>
</nav>
</div>
